...
<div class="container">
    ...
    <form method="post" action="<%=request.getContextPath() %>/Controller">
        ...
        <div class="form-group">
            ...
            <input type="text" id="studentid" name="studentid" value="<%=request.getAttribute("studentid") %> " required />
        </div>

        <div class="form-group">
            <label for="studentname">Student Name:</label>
            <input type="text" id="studentname" name="studentname" value="<%=request.getAttribute("studentname") %>" required/>
        </div>
