    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action.equals("student-form")) {
            ...
            try {
                ...
                request.getRequestDispatcher("student-add.jsp").forward(request, response);
                 ...
                 request.setAttribute("msg", "Oops.. Use Different ID.");
                request.getRequestDispatcher("student-add.jsp").forward(request, response);
                e.printStackTrace();
            }
        }
        ...
        if (action.equals("question-form")) {
            ...
            if (question.isEmpty() || option1.isEmpty() || option2.isEmpty() || option3.isEmpty() || option4.isEmpty() || answer.isEmpty()) {
                request.setAttribute("msg", "All fields must be filled out!");
                ...
                try {
                    ...
                    request.setAttribute("msg", "Question submitted successfully!");
                    request.getRequestDispatcher("question-add.jsp").forward(request, response);
                } catch (Exception e) {
                    e.printStackTrace();
                    request.setAttribute("msg", "Error submitting the question. Please try again.");
                    request.getRequestDispatcher("question-add.jsp").forward(request, response);
                }
            }
        }
